...
- **macOS: “cannot open files in the ‘folder’ format”.** The app bundle now
  ...
  (`e <folder>`) and with `⌘O` already worked.
...
- **Column editing.** `⌥⌘↑` / `⌥⌘↓` add a caret one line above / below at the
  same column, growing a vertical multi-cursor — the keyboard form of column
  selection. Also available from the command palette.
...
- **Cell value viewer.** Single-click a cell in the data grid to dock a read-only
  inspector at the bottom of the panel showing the full value — JSON objects and
  arrays are pretty-printed. Double-click still edits. (PhpStorm-style.)

### Fixed

- **Laravel settings tab overflowed the dialog.** The content pane sized itself to
  its widest row, pushing toggles and the App URL field off the right edge with a
  horizontal scrollbar; the pane is now pinned to the dialog width.
...
[Unreleased]: https://github.com/kwhorne/e/compare/v0.9.18...HEAD
[0.9.18]: https://github.com/kwhorne/e/compare/v0.9.17...v0.9.18
...
[0.9.6]: https://github.com/kwhorne/e/compare/v0.9.5...v0.9.6
[0.9.5]: https://github.com/kwhorne/e/compare/v0.9.4...v0.9.5
[0.9.4]: https://github.com/kwhorne/e/compare/v0.9.3...v0.9.4
[0.9.3]: https://github.com/kwhorne/e/compare/v0.9.2...v0.9.3
[0.9.2]: https://github.com/kwhorne/e/compare/v0.9.1...v0.9.2
[0.9.1]: https://github.com/kwhorne/e/compare/v0.9.0...v0.9.1
[0.9.0]: https://github.com/kwhorne/e/compare/v0.8.3...v0.9.0
[0.8.3]: https://github.com/kwhorne/e/compare/v0.8.2...v0.8.3
[0.8.2]: https://github.com/kwhorne/e/compare/v0.8.1...v0.8.2
[0.8.1]: https://github.com/kwhorne/e/compare/v0.8.0...v0.8.1
[0.8.0]: https://github.com/kwhorne/e/compare/v0.7.7...v0.8.0
[0.7.7]: https://github.com/kwhorne/e/compare/v0.7.6...v0.7.7
[0.7.6]: https://github.com/kwhorne/e/compare/v0.7.5...v0.7.6
[0.7.5]: https://github.com/kwhorne/e/compare/v0.7.4...v0.7.5
[0.7.4]: https://github.com/kwhorne/e/compare/v0.7.3...v0.7.4
[0.7.3]: https://github.com/kwhorne/e/compare/v0.7.2...v0.7.3
[0.7.2]: https://github.com/kwhorne/e/compare/v0.7.1...v0.7.2
[0.7.1]: https://github.com/kwhorne/e/compare/v0.7.0...v0.7.1
[0.7.0]: https://github.com/kwhorne/e/compare/v0.6.9...v0.7.0
[0.6.9]: https://github.com/kwhorne/e/compare/v0.6.8...v0.6.9
[0.6.8]: https://github.com/kwhorne/e/compare/v0.6.7...v0.6.8
[0.6.7]: https://github.com/kwhorne/e/compare/v0.6.6...v0.6.7
