...
Welcome to the documentation for **e**, the editor for the rest of us — a fast,
native code editor written in Rust.

## Contents

### Getting started
- [Installation](installation.md) — download, build, and run
- [Getting started](getting-started.md) — your first session
...
> Throughout these docs the modifier key is written as `⌘` (Command) on macOS.
> On Linux and Windows, use `Ctrl` instead.
